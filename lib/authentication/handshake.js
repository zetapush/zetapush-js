...
export class AuthentFactory {
   ...
   */
  static createSimpleHandshake({ deploymentId = Simple.DEFAULT_DEPLOYMENT_ID, login, password }) {
   ...
   */
  static createWeakHandshake({ deploymentId = Weak.DEFAULT_DEPLOYMENT_ID, token }) {
    return AuthentFactory.createHandshake({
   ...
   * @return {TokenHandshake}
   */
  static createDelegatingHandshake({ deploymentId = Delegating.DEFAULT_DEPLOYMENT_ID, token }) {
    return AuthentFactory.createHandshake({

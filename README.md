...
```console
bower install zetapush-js#2.0.0-beta.16 --save
```
...
```console
npm install zetapush-js@2.0.0-beta.16 --save
```
...
```html
<script src="//cdn.rawgit.com/zetapush/zetapush-js/v2.0.0-beta.16/dist/zetapush.js"></script>
```

...
```console
bower install zetapush-js#2.0.0-beta.23 --save
```
...
```console
npm install zetapush-js@2.0.0-beta.23 --save
```
...
```html
<script src="//npmcdn.com/zetapush-js@2.0.0-beta.23/dist/zetapush.min.js"></script>
```

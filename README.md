...
```console
bower install zetapush-js@2.0.0-beta.6 --save
```
...
```console
npm install zetapush-js@2.0.0-beta.6 --save
```
...
```html
<script src="https://static.zpush.io/js/2.0.0-beta.6/zetapush.min.js"></script>
```

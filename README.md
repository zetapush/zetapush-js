...
```console
bower install zetapush-js#2.0.0-rc.1 --save
```
...
```console
npm install zetapush-js@2.0.0-rc.1 --save
```
...
```html
<script src="//npmcdn.com/zetapush-js@2.0.0-rc.1/dist/zetapush.min.js"></script>
```

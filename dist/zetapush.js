...
},{"./cometd":12,"./utils":15,"zetapush-cometd":1}],11:[function(require,module,exports){
'use strict';
...
},{"./client-helper":10,"./utils":15}],12:[function(require,module,exports){
'use strict';
...
var DefaultZetapushHandshakeManager = function (_AbstractHandshakeMan2) {
  ...
  function DefaultZetapushHandshakeManager(_ref3) {
    ...
    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(DefaultZetapushHandshakeManager).call(this, { deploymentId: deploymentId, authType: authType }));
...
var AuthentFactory = exports.AuthentFactory = function () {
  ...
  _createClass(AuthentFactory, null, [{
    ...
    value: function createHandshake(_ref7) {
      ...
      if (null === password) {
        return new TokenHandshakeManager({ token: login, deploymentId: deploymentId, authType: authType });
      }
      return new DefaultZetapushHandshakeManager({ login: login, password: password, deploymentId: deploymentId, authType: authType });
    }
  }]);
...
},{"./client":11,"./handshake":13}],15:[function(require,module,exports){
'use strict';

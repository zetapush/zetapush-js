  ...
  _createClass(ClientHelper, [{
    ...
    value: function connect() {
      ...
      this.servers.then(function (servers) {
        ...
        _this2.cometd.handshake(_this2.handshake.getHandshakeFields(_this2));
      });
    }
  }, {
      ...
      this.servers.then(function (servers) {
        ...
        if (servers.length === 0) {
          // No more server available
            ...
            setTimeout(function () {
              _this3.cometd.handshake(_this3.handshake.getHandshakeFields(_this3));
            }, 250);
          }
      });
    }
    ...
    key: 'setHandshake',
    value: function setHandshake(handshake) {
      this.handshake = handshake;
    }
  }, {
    key: 'getBusinessId',
...
var Client = function () {
  ...
  _createClass(Client, [{
    ...
    key: 'handshake',
    value: function handshake(_handshake) {
      this.stop();
      if (_handshake) {
        this.client.setHandshake(_handshake);
      }
      this.start();
    }
  }]);
...
var SmartClient = exports.SmartClient = function () {
  function SmartClient(_ref) {
    ...
    var handshake = this.getHandshake({ deploymentId: deploymentId });
    ...
    this.client = new _client.Client({ apiUrl: apiUrl, businessId: businessId, handshake: handshake });
    this.addConnectionStatusListener({ onFailedHandshake: onFailedHandshake, onSuccessfulHandshake: onSuccessfulHandshake });
  }
  ...
  _createClass(SmartClient, [{
    ...
    key: 'getHandshake',
    value: function getHandshake(_ref3) {
      var deploymentId = _ref3.deploymentId;

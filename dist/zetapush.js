...
var ConnectionStatusListener = function () {
  ...
  _createClass(ConnectionStatusListener, [{
    ...
    value: function onSuccessfulHandshake() {}
  }, {
    key: 'onFailedHandshake',
    value: function onFailedHandshake() {}
  }, {
...
var ClientHelper = exports.ClientHelper = function () {
  ...
  function ClientHelper(_ref) {
    ...
    var handshakeFactory = _ref.handshakeFactory;
  ...
  _createClass(ClientHelper, [{
    ...
    value: function connect() {
      ...
      this.servers.then(function (servers) {
        ...
        _this2.cometd.addListener('/meta/handshake', function (_ref2) {
          var ext = _ref2.ext;
          ...
          if (successful) {
            ...
            _this2.initialized(authentication);
          } else {
            _this2.handshakeFailure(error);
          }
        });

        _this2.cometd.addListener('/meta/handshake', function (_ref3) {
          ...
          if (!successful) {
            ...
            if (Message.RECONNECT_NONE_VALUE === advice.reconnect) {
              _this2.authenticationFailed(error);
            } else if (Message.RECONNECT_HANDSHAKE_VALUE === advice.reconnect) {
              _this2.negotiate(ext);
            }
          }
        });

        _this2.cometd.addListener('/meta/connect', function (_ref4) {
          ...
          // ConnectionListener
          if (_this2.cometd.isDisconnected()) {
            _this2.connected = false;
            _this2.connectionClosed();
          } else {
            _this2.wasConnected = _this2.connected;
            _this2.connected = successful;
            if (!_this2.wasConnected && _this2.connected) {
              _this2.connectionEstablished();
            } else if (_this2.wasConnected && !_this2.connected) {
              _this2.connectionBroken();
            }
          }
        });
    ...
    value: function getHandshakeFields() {
      var handshake = this.handshakeFactory();
    ...
    key: 'setHandshakeFactory',
    value: function setHandshakeFactory(handshakeFactory) {
      this.handshakeFactory = handshakeFactory;
    }
    /**
     *
    ...
    key: 'unsubscribe',
    value: function unsubscribe(subscripions) {
      for (var method in subscripions) {
    ...
    value: function addConnectionStatusListener(listener) {
      var connectionListener = Object.assign(new ConnectionStatusListener(), listener);
...
},{"./cometd":12,"./utils":17,"zetapush-cometd":1}],11:[function(require,module,exports){
'use strict';
...
var Client = exports.Client = function () {
  ...
  _createClass(Client, [{
    ...
    value: function createServicePublisher(_ref2) {
      ...
      throw new _utils.NotYetImplementedError('createServicePublisher');
    }
    /**
     *
     */
    ...
    key: 'handshake',
    value: function handshake(handshakeFactory) {
      this.stop();
      if (handshakeFactory) {
...
},{"./client-helper":10,"./utils":17}],12:[function(require,module,exports){
'use strict';
...
var AbstractHandshakeManager = function () {
  /**
   *
   */
...
var TokenHandshakeManager = function (_AbstractHandshakeMan) {
...
var DefaultZetapushHandshakeManager = function (_AbstractHandshakeMan2) {
...
},{"./client":11,"./handshake":13,"./smart-client":15,"./token-persistence":16}],15:[function(require,module,exports){
'use strict';
...
var SmartClient = exports.SmartClient = function (_Client) {
  ...
  function SmartClient(_ref) {
    ...
    var handshakeFactory = function handshakeFactory() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SmartClient).call(this, { apiUrl: apiUrl, businessId: businessId, handshakeFactory: handshakeFactory, resource: resource }));
    ...
    _this.client.addConnectionStatusListener({ onFailedHandshake: onFailedHandshake, onSuccessfulHandshake: onSuccessfulHandshake });
...
},{"./client":11,"./handshake":13,"./token-persistence":16}],16:[function(require,module,exports){
'use strict';
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
